...
#define BL5372_DEVICE_ADDR     0x64      //BL5372  ADDR               //0x46    // BH1750  ADDR =0      : 0100 011x
...
extern u8 API_Write_Nbyte_I2C( u8 SlaveAdd, u8 SlaveOffset, u8* pWriteBuf, u8 n );
extern u8 API_Read_Nbyte_I2C(u8 SlaveAdd, u8 address,u8* pReadBuf, u8 n);
